# Generated by Django 4.2.3 on 2023-09-01 17:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Имя автора')),
            ],
            options={
                'verbose_name': 'Автор',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcsribers', models.ManyToManyField(related_name='categories', to=settings.AUTH_USER_MODEL)),
            ],
            options={
